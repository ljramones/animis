...
import org.dynamisengine.animis.runtime.ik.FabrikSolver;
...
final class RuntimeStressFuzzTest {
  ...
  void randomizedPipelineInputs_doNotProduceNaNOrInf() {
    ...
    final StateMachineDef machine = new StateMachineDef(
        "stress-sm",
        List.of(new StateDef("idle", new ClipNode(clipId, 1f), List.of(new TransitionDef("idle", new org.dynamisengine.animis.state.BoolParam("loop", true), 0.05f, false, 0f)))),
        "idle");
